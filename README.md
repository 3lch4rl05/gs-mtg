...
This script uses the awesome MTG API provided by [magicthegathering.io] Please consider becoming a [patron](https://www.patreon.com/magicthegathering) to support it!
